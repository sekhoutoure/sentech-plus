...
export default function PremiumHero() {
    ...
    return (
        <section className="relative px-4 sm:px-6 pt-4 pb-8 sm:py-8 max-w-[1400px] mx-auto">
            {/* Desktop 70% / 30% Layout Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-stretch">
                
                {/* 1. GRANDE CARTE HERO (70% - lg:col-span-8) - Hauteur contrôlée ~420-450px */}
                <div className="lg:col-span-8 relative flex flex-col justify-between bg-gradient-to-br from-[#071126] via-[#0B1E3F] to-[#071126] rounded-3xl p-6 sm:p-9 lg:p-10 text-white overflow-hidden border border-slate-800/80 shadow-2xl min-h-[420px] sm:min-h-[450px] group">
                    ...
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-center flex-1">
                        ...
                        <div className="md:col-span-7 space-y-4">
                            ...
                            {/* Title (30-36px mobile, 42-52px desktop) */}
                            <h1 className="text-3xl sm:text-[36px] lg:text-[46px] font-black tracking-tight text-white leading-[1.10]">
                                Des accessoires intelligents pour simplifier votre quotidien.
                            </h1>

                            {/* Description (15-17px) */}
                            <p className="text-slate-300 text-sm sm:text-[16px] font-normal leading-relaxed max-w-md">
                        ...
                        {/* Right: Grande Image Produit Occupant Tout le Remplissage */}
                        <div className="md:col-span-5 relative h-60 sm:h-72 lg:h-full flex items-center justify-center p-1">
                            <div className="relative w-full h-full min-h-[250px] sm:min-h-[290px] rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md p-2 flex items-center justify-center overflow-hidden">
                                    ...
                                    >
                                        <div className="relative w-full h-full">
                                            <Image
                                                ...
                                                fill
                                                className="object-contain drop-shadow-[0_20px_35px_rgba(0,0,0,0.6)] group-hover:scale-108 transition-transform duration-700"
                                                priority={index === 0}
                                            />
                                        </div>
                                    </div>
                ...
                <div className="lg:col-span-4 flex flex-col gap-5 sm:gap-6 justify-between">
                    ...
                    <div className="relative flex-1 bg-white rounded-3xl p-6 sm:p-7 border border-[#EBEBEB] shadow-sm hover:shadow-xl hover:border-[#1769FF]/30 transition-all duration-300 flex flex-col justify-between group overflow-hidden min-h-[200px]">
                    ...
                    <div className="relative flex-1 bg-gradient-to-br from-amber-500 via-orange-500 to-amber-600 rounded-3xl p-6 sm:p-7 text-white shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col justify-between group overflow-hidden min-h-[200px]">
