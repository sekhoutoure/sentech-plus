...
export default function WhatsAppButton() {
    ...
    return (
        <aside aria-label="Support WhatsApp" className="fixed bottom-6 right-4 sm:right-6 z-40 group">
            {/* Pulse rings */}
            ...
            <a
                ...
                className="relative flex items-center gap-3 bg-[#25D366] hover:bg-[#1EBD58] text-white pl-3 pr-5 py-3 rounded-full shadow-xl shadow-[#25D366]/35 hover:shadow-[#25D366]/50 hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer"
            >
                {/* WhatsApp Icon */}
                <div className="size-9 rounded-full bg-white/20 flex items-center justify-center shrink-0">
                    <svg viewBox="0 0 32 32" className="size-5 fill-white" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col text-left">
                    <span className="text-[10px] text-green-100 font-semibold leading-none">Besoin d'aide ?</span>
