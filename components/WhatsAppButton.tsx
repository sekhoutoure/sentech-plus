...
export default function WhatsAppButton() {
    ...
    const message = encodeURIComponent('Bonjour SenTechPLUS ! Je souhaite avoir des informations sur vos équipements High-Tech.')
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* WhatsApp Icon */}
                <div className="size-6 sm:size-5 flex items-center justify-center shrink-0">
                ...
                <div className="hidden sm:flex flex-col text-left ml-2">
                    ...
                    <span className="text-xs font-bold text-white leading-tight">WhatsApp</span>
                </div>
            </a>
        </aside>
    )
