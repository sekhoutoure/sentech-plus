...
export default function CategoryNav() {
    ...
    return (
        <nav aria-label="Catégories principales" className="w-full bg-white border-b border-[#E8EDF3] shadow-2xs">
                    ...
                    {categories.map((cat, idx) => {
                        ...
                        return (
                            <Link
                                ...
                                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-semibold text-[#182230] hover:text-[#1677FF] hover:bg-[#EAF3FF] transition-all duration-200 shrink-0 group border border-transparent hover:border-[#1677FF]/20"
                            >
                                <Icon size={16} className="text-[#667085] group-hover:text-[#1677FF] transition-colors shrink-0" />
