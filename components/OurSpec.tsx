...
const OurSpecs: React.FC = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Nos engagements' description="Nous vous offrons un service haut de gamme pour garantir une expérience d'achat fluide, sécurisée et totalement sans tracas." />
