...
export default function PromoBanner() {
    return (
        <section className="px-3 sm:px-6 my-4 sm:my-14 lg:my-20 max-w-[1400px] mx-auto">
            <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-[#071126] text-white border border-slate-800/80 shadow-lg">

                {/* Ambient Glow */}
                <div className="absolute -top-32 -left-32 size-[250px] sm:size-[500px] bg-[#1769FF]/20 rounded-full blur-[70px] sm:blur-[120px] pointer-events-none" />
                <div className="absolute -bottom-32 -right-32 size-[200px] sm:size-[400px] bg-purple-700/15 rounded-full blur-[60px] sm:blur-[100px] pointer-events-none" />
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-10 items-center p-3.5 sm:p-10 lg:p-14">
                    ...
                    <div className="lg:col-span-6 space-y-2 sm:space-y-5 text-center lg:text-left">
                        <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-[9px] sm:text-xs font-extrabold text-amber-300">
                        ...
                        <div className="pt-0.5 flex items-center justify-center lg:justify-start gap-2">
                            <Link
                                href="/shop"
                                className="inline-flex items-center justify-center gap-1 bg-[#1769FF] hover:bg-[#1256D6] text-white font-extrabold text-xs sm:text-sm py-2 sm:py-3.5 px-4 sm:px-7 rounded-xl sm:rounded-2xl shadow-md active:scale-95 transition-all"
                            >
